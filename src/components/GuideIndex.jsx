...
export default function GuideIndex() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-6 rounded shadow">
      ...
      <p className="mb-4 text-sm text-gray-600">Introduce el identificador de la guía (por ejemplo: <code>guia-1</code>) y pulsa "Ir" para ver la guía.</p>
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          placeholder="Ingresa ID de guía (ej. guia-1)"
        />
